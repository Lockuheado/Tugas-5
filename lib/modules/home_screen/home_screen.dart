...
class _HomeScreenState extends State<HomeScreen> {
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    child: HotestNewsCard(
                      size: size,
                      newsTitle: "News from the newest car from Mclarens F1 Teams",
                      pictureUrl: "https://a2.espncdn.com/combiner/i?img=%2Fphoto%2F2023%2F0213%2Fr1130874_1296x729_16%2D9.jpg&w=570&format=jpg", 
                      onTap: () {},
                    ),
                  ),
                ),
  ...
  BottomNavigationBarItem bottomMenuItem(
    String label,
    IconData iconData, {required Color color}
  ) {
